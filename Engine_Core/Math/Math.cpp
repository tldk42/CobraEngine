...
template<> const FVector2f FVector2f::Unit45Deg(CB_INVERSE_SQRT_2, CB_INVERSE_SQRT_2);
template<> const FVector2d FVector2d::ZeroVector(0, 0);
template<> const FVector2d FVector2d::UnitVector(1, 1);
template<> const FVector2d FVector2d::Unit45Deg(CB_INVERSE_SQRT_2, CB_INVERSE_SQRT_2);